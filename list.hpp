...
/*   Updated: 2021/03/31 18:51:51 by fbarbera         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template<class T> 
	...
	public:
		...
		protected:
			...
			Node<T>	*Get_node() const {return Head;}
		public:
			const_iterator(Node<T> *Head) : Head(Head) {}
			const_iterator(const_iterator const &other) : Head(other.Get_node()) {}
			const_iterator() {}
			T const *operator->() { return &Head->content; }
			T const &operator*() const { return Head->content; }
			const_iterator &operator++() { Head = Head->Next; return *this;}
			const_iterator operator++(int) { const_iterator tmp = *this; ++(*this); return tmp;}
			const_iterator &operator--() { Head = Head->Prev; return *this;}
			const_iterator operator--(int) { const_iterator tmp = *this; --(*this); return tmp;}
			friend bool operator== (const const_iterator& a, const const_iterator& b) { return a.operator*() == b.operator*(); };
			friend bool operator!= (const const_iterator& a, const const_iterator& b) { return a.operator*() != b.operator*(); };
		};
